...
<div className={`ms-Grid`}>
  ...
  <div className={`ms-Grid-col ms-sm12 ${styles.headTitle}`}>
  <div className={`ms-font-1  ${styles.headPanel}`}>Global Service Desk</div>
    <hr/>
    <br/>
   </div> </div>

   <div className={`ms-Grid-row `} >
   <div className={`ms-Grid-col ms-sm12 ${styles.headCol}`}>
   <div className={`ms-font-1  ${styles.headPanel1}`}>Report Suspicious Activity
    <br/>    <br/>    <br/>
    </div>
    </div> </div>
   <br/>
   <div className={`ms-Grid-row `} >
   <div className={`ms-Grid-col ms-sm12 ${styles.headCol}`}>
   <div className={`ms-font-1  ${styles.headPanel1}`}>Online IT Support
    <br/>    <br/>    <br/>
    </div>
    </div> </div>
    <br/>
   <div className={`ms-Grid-row `} >
   <div className={`ms-Grid-col ms-sm12 ${styles.headCol}`}>
   <div className={`ms-font-1  ${styles.headPanel1}`}>Online e-Store
    <br/>    <br/>    <br/>
    </div>
    </div> </div>
    <br/>
    <div className={`ms-Grid-row `} >
    <div className={`ms-Grid-col ms-sm12 ${styles.headCol}`}>
    <div className={`ms-font-1  ${styles.headPanel1}`}>Americas
    <br/>    <br/>    
    </div>
    
    <div className={`ms-font-1  ${styles.headPanel2}`}>APAC
    <br/>    <br/>    
    </div>
    <div className={`ms-font-1  ${styles.headPanel2}`}>EMEA ECS   
    <br/>    <br/>    
    </div>

    <div className={`ms-font-1  ${styles.headPanel2}`}>EMEA GC | AVR   <br/>    <br/>    
    </div>
